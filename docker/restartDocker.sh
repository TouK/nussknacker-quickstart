...
../common/scripts/waitForOkFromUrl.sh "api/processes/status" "Checking connect with Flink.." "Nussknacker not connected with flink" "designer"
../common/scripts/waitForOkFromUrl.sh "flink/" "Checking Flink response.." "Flink not started" "runtime"
